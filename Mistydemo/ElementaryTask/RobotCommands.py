...
#####################################################
    ...
    def get_audio_file(self, fileName : str = None, base64 : bool = None) -> Response:
    ...
    def get_file_names(self, directoryName : str = None, device : str = None) -> Response:
    ...
    def get_video_recording(self, name : str = None, base64 : bool = None) -> Response:
    ...
    def get_object_temperature(self, roiLeft : int = None, roiWidth : int = None, roiTop : int = None, roiHeight : int = None, algorithm : int = None, debug : bool = None) -> Response:
    ...
    def get_subject_temperature(self, calROILeft : int = None, calROIWidth : int = None, calROITop : int = None, calROIHeight : int = None, subjectROILeft : int = None, subjectROIWidth : int = None, subjectROITop : int = None, subjectROIHeight : int = None, calTemperature : float = None) -> Response:
    ...
    def take_picture(self, base64 : bool = None, fileName : str = None, width : int = None, height : int = None, displayOnScreen : bool = None, overwriteExisting : bool = None) -> Response:
    ...
    def bluetooth_sensor_discover_and_connect(self, name : str = None, serviceRecord : str = None, messageSize : bytes = None) -> Response:
        ...
        return self.post_request("bluetooth/rfcomm/discoverandconnect", json=json)
    ...
    def configure_dialog(self, nlpService : str = None, nlpServiceKey : str = None, nlpServiceRegion : str = None, nlpServiceEndpoint : str = None, asrService : str = None, asrServiceKey : str = None, asrServiceRegion : str = None, asrServiceEndpoint : str = None, ttsService : str = None, ttsServiceKey : str = None, ttsServiceRegion : str = None, ttsServiceEndpoint : str = None) -> Response:
    ...
    def play_and_listen(self, audioFile : str = None, context : str = None) -> Response:
    ...
    def set_context(self, context : str = None, filteredIntents : str = None, overlapContexts : bool = None, retrain : bool = None) -> Response:
    ...
    def speak_and_listen(self, text : str = None, flush : bool = None, utteranceId : str = None, context : str = None) -> Response:
    ...
    def train_nlp_engine(self, context : str = None, intents : object = None, save : bool = None, overwrite : bool = None) -> Response:
    ...
    def update_dialog_settings(self, userLanguage : int = None, silenceTimeoutMs : int = None, maxSpeechLengthMs : int = None, sendInterimEvents : bool = None, pitch : float = None, speechRate : float = None, voice : str = None, confidence : float = None) -> Response:
    ...
    def create_action(self, name : str = None, script : str = None, overwrite : bool = None) -> Response:
    ...
    def create_conversation(self, name : str = None, startingState : str = None, description : str = None, useVisionData : bool = None, overwrite : bool = None) -> Response:
    ...
    def create_user_data(self, group : str = None, match : str = None, replaceString : str = None) -> Response:
    ...
    def map_state(self, conversation : str = None, state : str = None, trigger : str = None, triggerFilter : str = None, nextState : str = None, detail : str = None, nextConversation : str = None, reEntry : bool = None, includeFollowUp : bool = None, overwrite : bool = None) -> Response:
    ...
    def start_action(self, name : str = None, useVisionData : bool = None) -> Response:
    ...
    def start_robot_interaction_event(self, useVisionData : bool = None) -> Response:
    ...
    def start_state(self, name : str = None, useVisionData : bool = None) -> Response:
    ...
    def update_conversation(self, currentName : str = None, newName : str = None, startingState : str = None, useVisionData : bool = None, description : str = None) -> Response:
    ...
    def speak(self, text : str = None, pitch : float = None, speechRate : float = None, voice : str = None, flush : bool = None, utteranceId : str = None, language : str = None) -> Response:
    ...
    def speak_azure(self, text : str = None, isSSML : bool = None, utteranceId : str = None, speechKey : str = None, speechRegion : str = None, voice : str = None, language : str = None, useCaching : bool = None, trimSilence : bool = None, trimSilenceAggressiveness : int = None) -> Response:
    ...
    def start_av_streaming(self, url : str = None, width : int = None, height : int = None, frameRate : int = None, videoBitRate : int = None, audioBitRate : int = None, audioSampleRateHz : int = None, userName : str = None, password : str = None) -> Response:
    ...
    def start_recording_video(self, fileName : str = None, mute : bool = None, duration : int = None, width : int = None, height : int = None) -> Response:
    ...
    def start_video_streaming(self, port : int = None, rotation : int = None, width : int = None, height : int = None, quality : int = None, overlay : bool = None) -> Response:
    ...
    def connect_wi_fi(self, networkName : str = None, password : str = None) -> Response:
    ...
    def override_skill_start(self, skill : str = None, startRule : str = None) -> Response:
    ...
    def perform_targeted_update(self, components : str = None, overrideBatteryCheck : bool = None) -> Response:
    ...
    def rename_video_recording(self, oldName : str = None, newName : str = None) -> Response:
    ...
    def restart_robot(self, core : bool = None, sensoryServices : bool = None) -> Response:
    ...
    def save_audio(self, fileName : str = None, data : str = None, immediatelyApply : bool = None, overwriteExisting : bool = None) -> Response:
    ...
    def save_image(self, fileName : str = None, data : str = None, width : int = None, height : int = None, immediatelyApply : bool = None, overwriteExisting : bool = None) -> Response:
    ...
    def save_skill_files(self, file : bytes = None, overwriteExisting : bool = None, uniqueId : str = None, authToken : str = None, type : str = None) -> Response:
    ...
    def save_video(self, fileName : str = None, data : str = None, immediatelyApply : bool = None, overwriteExisting : bool = None) -> Response:
    ...
    def set_blink_settings(self, revertToDefault : bool = None, closedEyeMinMs : int = None, closedEyeMaxMs : int = None, openEyeMinMs : int = None, openEyeMaxMs : int = None, blinkImages : str = None) -> Response:
    ...
    def set_image_display_settings(self, layer : str = None, revertToDefault : bool = None, deleted : bool = None, visible : bool = None, opacity : float = None, width : int = None, height : int = None, stretch : str = None, rotation : int = None, horizontalAlignment : str = None, verticalAlignment : str = None, placeOnTop : bool = None) -> Response:
    ...
    def set_log_level(self, localLogLevel : str = None, remoteLogLevel : str = None) -> Response:
    ...
    def set_notification_settings(self, revertToDefault : bool = None, ledEnabled : bool = None, keyPhraseEnabled : bool = None, keyPhraseFile : str = None) -> Response:
    ...
    def set_tally_light_settings(self, microphone : bool = None, rgbCamera : bool = None, slamCamera : bool = None) -> Response:
    ...
    def set_text_display_settings(self, layer : str = None, revertToDefault : bool = None, deleted : bool = None, visible : bool = None, opacity : float = None, size : int = None, weight : int = None, wrap : bool = None, horizontalAlignment : str = None, verticalAlignment : str = None, style : str = None, red : bytes = None, green : bytes = None, blue : bytes = None, padLeft : int = None, padTop : int = None, padRight : int = None, padBottom : int = None, rotation : int = None, fontFamily : str = None, placeOnTop : bool = None, width : int = None, height : int = None) -> Response:
    ...
    def set_video_display_settings(self, layer : str = None, revertToDefault : bool = None, deleted : bool = None, visible : bool = None, opacity : float = None, width : int = None, height : int = None, stretch : str = None, rotation : int = None, horizontalAlignment : str = None, verticalAlignment : str = None, repeat : bool = None, placeOnTop : bool = None) -> Response:
    ...
    def set_web_view_display_settings(self, layer : str = None, revertToDefault : bool = None, deleted : bool = None, visible : bool = None, width : int = None, height : int = None, stretch : str = None, horizontalAlignment : str = None, verticalAlignment : str = None, placeOnTop : bool = None) -> Response:
    ...
    def trigger_skill_event(self, skill : str = None, eventName : str = None, payload : str = None, source : str = None) -> Response:
    ...
    def update_hazard_settings(self, revertToDefault : bool = None, disableTimeOfFlights : bool = None, disableBumpSensors : bool = None, bumpSensorsEnabled : str = None, timeOfFlightThresholds : str = None, disableTiltThreshold : bool = None, tiltThreshold : bytes = None) -> Response:
    ...
    def capture_speech(self, overwriteExisting : bool = None, silenceTimeout : int = None, maxSpeechLength : int = None, requireKeyPhrase : bool = None, speechRecognitionGrammar : str = None) -> Response:
    ...
    def capture_speech_azure(self, overwriteExisting : bool = None, silenceTimeout : int = None, maxSpeechLength : int = None, requireKeyPhrase : bool = None, captureFile : bool = None, speechRecognitionLanguage : str = None, azureSpeechKey : str = None, azureSpeechRegion : str = None) -> Response:
    ...
    def capture_speech_deep_speech(self, overwriteExisting : bool = None, silenceTimeout : int = None, maxSpeechLength : int = None, requireKeyPhrase : bool = None, captureFile : bool = None) -> Response:
    ...
    def capture_speech_google(self, overwriteExisting : bool = None, silenceTimeout : int = None, maxSpeechLength : int = None, requireKeyPhrase : bool = None, captureFile : bool = None, speechRecognitionLanguage : str = None, googleSpeechKey : str = None) -> Response:
    ...
    def capture_speech_vosk(self, overwriteExisting : bool = None, silenceTimeout : int = None, maxSpeechLength : int = None, requireKeyPhrase : bool = None, captureFile : bool = None) -> Response:
    ...
    def display_image(self, fileName : str = None, alpha : float = None, layer : str = None, isURL : bool = None) -> Response:
    ...
    def change_led(self, red : bytes = None, green : bytes = None, blue : bytes = None) -> Response:
    ...
    def display_video(self, filename : str = None, layer : str = None, isURL : bool = None) -> Response:
    ...
    def drive_arc(self, heading : float = None, radius : float = None, timeMs : float = None, reverse : bool = None) -> Response:
    ...
    def drive_time(self, linearVelocity : float = None, angularVelocity : float = None, timeMs : int = None, degree : float = None) -> Response:
    ...
    def drive_heading(self, heading : float = None, distance : float = None, timeMs : float = None, reverse : bool = None) -> Response:
    ...
    def drive_track(self, leftTrackSpeed : float = None, rightTrackSpeed : float = None) -> Response:
    ...
    def move_arm(self, arm : str = None, position : float = None, velocity : float = None, duration : float = None, units : str = None) -> Response:
    ...
    def move_arms(self, leftArmPosition : float = None, rightArmPosition : float = None, leftArmVelocity : float = None, rightArmVelocity : float = None, duration : float = None, units : str = None) -> Response:
    ...
    def move_head(self, pitch : float = None, roll : float = None, yaw : float = None, velocity : float = None, duration : float = None, units : str = None) -> Response:
    ...
    def send_external_request(self, method : str = None, resource : str = None, authorizationType : str = None, token : str = None, arguments : bytes = None, save : bool = None, apply : bool = None, fileName : str = None, contentType : str = None) -> Response:
    ...
    def start_ar_tag_detector(self, dictionary : int = None, tagSizeMm : float = None) -> Response:
    ...
    def start_cascade_classifier(self, classifierId : int = None, scaleFactor : float = None, minNeighbors : int = None, minSizeWidth : int = None, minSizeHeight : int = None, maxSizeWidth : int = None, maxSizeHeight : int = None) -> Response:
    ...
    def start_key_phrase_recognition(self, overwriteExisting : bool = None, silenceTimeout : int = None, maxSpeechLength : int = None, captureSpeech : int = None, speechRecognitionGrammar : str = None) -> Response:
    ...
    def start_key_phrase_recognition_azure(self, overwriteExisting : bool = None, silenceTimeout : int = None, maxSpeechLength : int = None, captureSpeech : int = None, captureFile : bool = None, speechRecognitionLanguage : str = None, azureSpeechKey : str = None, azureSpeechRegion : str = None) -> Response:
    ...
    def start_key_phrase_recognition_deep_speech(self, overwriteExisting : bool = None, silenceTimeout : int = None, maxSpeechLength : int = None, captureSpeech : int = None, captureFile : bool = None) -> Response:
    ...
    def start_key_phrase_recognition_google(self, overwriteExisting : bool = None, silenceTimeout : int = None, maxSpeechLength : int = None, captureSpeech : int = None, captureFile : bool = None, speechRecognitionLanguage : str = None, googleSpeechKey : str = None) -> Response:
    ...
    def start_key_phrase_recognition_vosk(self, overwriteExisting : bool = None, silenceTimeout : int = None, maxSpeechLength : int = None, captureSpeech : int = None, captureFile : bool = None) -> Response:
    ...
    def start_object_detector(self, minimumConfidence : float = None, modelId : int = None, maxTrackerHistory : int = None, delegateType : int = None) -> Response:
    ...
    def start_pose_estimation(self, minimumConfidence : float = None, modelId : int = None, delegateType : int = None) -> Response:
    ...
    def transition_led(self, red : bytes = None, green : bytes = None, blue : bytes = None, red2 : bytes = None, green2 : bytes = None, blue2 : bytes = None, transitionType : str = None, timeMs : float = None) -> Response:
    ...
    def delete_user_data(self, group : str = None, match : str = None) -> Response:
    ...
    def remove_map_state(self, conversation : str = None, state : str = None, trigger : str = None, triggerFilter : str = None, detail : str = None) -> Response:
    ...
    def delete_skill(self, skill : str = None, authToken : str = None) -> Response:
...
if __name__ == "__main__":
    ...
    misty = RobotCommands('67.20.198.102')
    misty.speak("Hello")
